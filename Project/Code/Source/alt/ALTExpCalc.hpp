...
public:
	...
	bool	InsertConstSym(const CHAR_TYPE*szSym,VALUE_TYPE Value);
	bool	InsertPtrSym(const CHAR_TYPE*szSym,void*pValue,int Length);
	bool	InsertFuncSym(const CHAR_TYPE*szSym,FPValueFunc fpFunc,void*Param);
	void	ClearAllSym();
	void	ClearConstSym();
	void	ClearPtrSym();
	void	ClearFuncSym();
	bool	RemoveSym(const CHAR_TYPE*szSym);
...
private:
	bool CalcItem(const STExpItemListIT&ItemIter,STExpItemList&ExpItemList);
...
template<class CHAR_TYPE,class VALUE_TYPE,bool bIgnoreCase>
bool TExpCalc<CHAR_TYPE,VALUE_TYPE,bIgnoreCase>::InsertConstSym(const CHAR_TYPE*szSym,VALUE_TYPE Value)
{
...
template<class CHAR_TYPE,class VALUE_TYPE,bool bIgnoreCase>
bool TExpCalc<CHAR_TYPE,VALUE_TYPE,bIgnoreCase>::InsertPtrSym(const CHAR_TYPE*szSym,void*pValue,int Length)
{
	CExpCalcSymMapIT Iter = m_SymMap.InsertUnique(szSym);
	if(Iter==m_SymMap.End())
		return false;
...
template<class CHAR_TYPE,class VALUE_TYPE,bool bIgnoreCase>
bool TExpCalc<CHAR_TYPE,VALUE_TYPE,bIgnoreCase>::InsertFuncSym(const CHAR_TYPE*szSym,FPValueFunc fpFunc,void*Param)
{
...
void TExpCalc<CHAR_TYPE,VALUE_TYPE,bIgnoreCase>::ClearConstSym()
{
	...
	{
		if(Iter->Type == CExpCalcSym::CONSTANT) //JLS CONST -> CONSTANT
		{
			RemoveIter = Iter;
			Iter++;
...
template<class CHAR_TYPE,class VALUE_TYPE,bool bIgnoreCase>
bool TExpCalc<CHAR_TYPE,VALUE_TYPE,bIgnoreCase>::RemoveSym(const CHAR_TYPE*szSym)
{
...
template<class CHAR_TYPE,class VALUE_TYPE,bool bIgnoreCase>
bool TExpCalc<CHAR_TYPE,VALUE_TYPE,bIgnoreCase>::CalcItem(const STExpItemListIT&ItemIter,STExpItemList&ExpItemList)
{
	STExpItem*pResult;
	STOptFunc*pOptFunc;
