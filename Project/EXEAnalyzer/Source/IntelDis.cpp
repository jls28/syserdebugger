...
const BYTE SegmentValue[8] =
{
	0x26,0x2e,0x36,0x3e,0x64,0x65,0x00,0x00
};

const char * const SegReg[8] =
{
	"ES","CS","SS","DS","FS","GS","??","??"
};

const char * const RegByte[8] =
{
	"AL","CL","DL","BL","AH","CH","DH","BH"
};

const char * const RegByteFor64bit[16] =
{
...
const char * const RegWord[16] =
{
	"AX","CX","DX","BX","SP","BP","SI","DI",
	"R8W","R9W","R10W","R11W","R12W","R13W","R14W","R15W",
};
const char * const RegQWord[16] =
{
	"RAX","RCX","RDX","RBX","RSP","RBP","RSI","RDI",
	"R8","R9","R10","R11","R12","R13","R14","R15",
};
const char * const RegDWord[16] =
{
	"EAX","ECX","EDX","EBX","ESP","EBP","ESI","EDI",
	"R8D","R9D","R10D","R11D","R12D","R13D","R14D","R15D",
};
const char * const RegMMXQWord[8] =
{
	"MM0","MM1","MM2","MM3","MM4","MM5","MM6","MM7",
};
const char * const RegCR[16] =
{
	"CR0","CR1","CR2","CR3","CR4","CR5","CR6","CR7",
	"CR8","CR9","CR10","CR11","CR12","CR13","CR14","CR15",
};

const char * const RegTR[16] =
{
	"TR0","TR1","TR2","TR3","TR4","TR5","TR6","TR7",
	"TR8","TR9","TR10","TR11","TR12","TR13","TR14","TR15",
};

const char * const RegDR[16] =
{
	"DR0","DR1","DR2","DR3","DR4","DR5","DR6","DR7",
	"DR8","DR9","DR10","DR11","DR12","DR13","DR14","DR15",
};
const char * const RegXMMOWord[16] =
{
	"XMM0","XMM1","XMM2","XMM3","XMM4","XMM5","XMM6","XMM7",
	"XMM8","XMM9","XMM10","XMM11","XMM12","XMM13","XMM14","XMM15",
};
const char * const RegFPU[9] =
{
	"ST(0)","ST(1)","ST(2)","ST(3)","ST(4)","ST(5)","ST(6)","ST(7)","ST"
	
};

const char * const FlagS[2][8]=
{
	{"NV","UP","DI","PL","NZ","NA","PO","NC"},
	{"OV","DN","EI","NG","ZR","AC","PE","CY"}
};

const char * const FlagICE[2][8]=
{
	{"o","d","i","s","z","a","p","c"},
	{"O","D","I","S","Z","A","P","C"}
};

const BYTE Segment[8] =
{
	0x26,0x2e,0x36,0x3e,0x64,0x65,0x00,0x00
};

const char * const CtrReg[8] =
{
	"IP","EIP","FLAGS","FLAG","FL","EFLAGS","EFLAG","EFL"
};

const char * const RegName[][8] =
{
	{"ES","CS","SS","DS","FS","GS","??","??"},
	{"AL","CL","DL","BL","AH","CH","DH","BH"},
	{"AX","CX","DX","BX","SP","BP","SI","DI"},
...
const DIS_OPCODE_T Group0x0f00[] = //CPU保护模式指令
{
...
const DIS_OPCODE_T Group0x0fba[] =  //80386
{
	{R_M, C_NULL,												}, //0x0
	{R_M, C_NULL,												}, //0x1
	{R_M, C_NULL,												}, //0x2
...
//intel 指令表格
//----------------------------------------------------------------
const DIS_OPCODE_T Group0x80[] = //immediate group
{
...
const DIS_OPCODE_T Group0x81[] = //immediate group
{
...
const DIS_OPCODE_T Group0x82[] = //immediate group
{
...
const DIS_OPCODE_T Group0x83[] = //immediate group
{
...
const DIS_OPCODE_T Group0xc0[] = //shift group
{
...
void ReadIntelName(const char *s,int num)
{
	int i;
	const DIS_OPCODE_T *p = (const DIS_OPCODE_T*)s;
...
const char * const * GetIntelConstName(int *pNumb)
{
	int i;
...
const char * const * CIntelDisassembler::GetIntelConstName(int *pNumb)
{
