...
public:
	...
	char*m_StrTabBuf;
	static const DWORD m_ObjMachineSign[];
	const char* GetSectionName(int SectionIndex) const;
	const char* GetSymbolName(OBJ_IMAGE_SYMBOL* Sym) const;
	const char* GetSymbolNameByIndex(DWORD Index) const;
