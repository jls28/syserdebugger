...
bool CRegHelpWnd::DrawRegister(int x, int y,unsigned int NumberMask,unsigned int  ReservedMask,unsigned int LineMask,unsigned int OtherMask, CWispDC DrawDC,REGISTERBITNAME *RegBitName, const WISP_CHAR *RegisterName)
{
	...
	FontHeight = DrawDC.GetTextHeight(/*WISP_CHAR("M") JLS*/);
	//画背景色
