...
{
	const WISP_CHAR *RegName;
	int BeginBitIndex;
	int BitLen;
	const WISP_CHAR *Descriptor;
}REGISTERBITNAME;
...
public:
	...
	bool	DrawRegister(int x, int y,unsigned int NumberMask,unsigned int  ReservedMask,unsigned int LineMask,unsigned int OtherMask, CWispDC DrawDC,REGISTERBITNAME *RegBitName=NULL, const WISP_CHAR *RegisterName=NULL);
