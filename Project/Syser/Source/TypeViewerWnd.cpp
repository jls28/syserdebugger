...
void CTypeViewerWnd::AddArrayTypeWatch(CSDSModule* pSDSModule,DWORD TypeIndex,DWORD Address,DWORD Attribute,HANDLE hItem, const char* DataMemberName,bool bIsData)
{
	WCHAR ValueBuf[30];
...
void CTypeViewerWnd::AddClassVFPTRWatch(CSDSModule* pSDSModule,DWORD TypeIndex,DWORD Address,DWORD Attribute,HANDLE hItem, const char* DataMemberName)
{
	WCHAR ValueBuf[30];
	WCHAR UndefineValue[]=WSTR("????????");
	NUM_PTR NumPtr;
...
void CTypeViewerWnd::AddEnumerationTypeWatch(CSDSModule* pSDSModule,DWORD TypeIndex,DWORD Address,DWORD Attribute,HANDLE hItem, const char* DataMemberName,bool bIsData)
{
	VALUEUNION ValueUnion;
	WCHAR ValueBuf[30]={0};
	WCHAR UndefineValue[]=WSTR("????????");
...
void CTypeViewerWnd::AddPointerTypeWatch(CSDSModule* pSDSModule,DWORD TypeIndex,DWORD Address,DWORD Attribute,HANDLE hItem, const char* DataMemberName,bool bIsData)
{
	WCHAR ValueBuf[30];
	WCHAR UndefineValue[]=WSTR("????????");
	VALUEUNION ValueUnion;
...
void CTypeViewerWnd::WatchType(CSDSModule* pSDSModule,DWORD TypeIndex,DWORD Address,DWORD Attribute,HANDLE hItem, const char* DataMemberName)
{
	NUM_PTR NumPtr;
...
void CTypeViewerWnd::AddBaseClassTypeWatch(CSDSModule* pSDSModule,DWORD TypeIndex,DWORD Address,DWORD Attribute,HANDLE hItem, const char* DataMemberName,bool bIsData)
{
	char Buf[256];
	char* pStr=Buf;
	PSDTYPE_INFILE pType;
...
void CTypeViewerWnd::AddUdtTypeWatch(CSDSModule* pSDSModule,DWORD TypeIndex,DWORD Address,DWORD Attribute,HANDLE hItem, const char* DataMemberName,bool bIsData)
{
	char Buf[256];
	char* pStr=Buf;
	PSDTYPE_INFILE pType;
...
void CTypeViewerWnd::AddBasicTypeWatch(CSDSModule* pSDSModule,DWORD TypeIndex,DWORD Address,DWORD Attribute,HANDLE hItem, const char* DataMemberName,bool bIsData)
{
	NUM_PTR NumPtr;
