...
public:
	...
	void WatchType(CSDSModule* pSDSModule,DWORD TypeIndex,DWORD Address,DWORD Attribute,HANDLE hItem=NULL, const char* DataMemberName=NULL);
	
	void AddUdtTypeWatch(CSDSModule* pSDSModule,DWORD TypeIndex,DWORD Address,DWORD Attribute,HANDLE hItem=NULL, const char* DataMemberName=NULL,bool bIsData=false);
	void AddBaseClassTypeWatch(CSDSModule* pSDSModule,DWORD TypeIndex,DWORD Address,DWORD Attribute,HANDLE hItem=NULL, const char* DataMemberName=NULL,bool bIsData=false);
	
	void AddEnumerationTypeWatch(CSDSModule* pSDSModule,DWORD TypeIndex,DWORD Address,DWORD Attribute,HANDLE hItem=NULL, const char* DataMemberName=NULL,bool bIsData=false);
	void AddPointerTypeWatch(CSDSModule* pSDSModule,DWORD TypeIndex,DWORD Address,DWORD Attribute,HANDLE hItem, const char* DataMemberName=NULL,bool bIsData=false);
	void AddArrayTypeWatch(CSDSModule* pSDSModule,DWORD TypeIndex,DWORD Address,DWORD Attribute,HANDLE hItem, const char* DataMemberName=NULL,bool bIsData=false);
	void AddBasicTypeWatch(CSDSModule* pSDSModule,DWORD TypeIndex,DWORD Address,DWORD Attribute,HANDLE hItem, const char* DataMemberName=NULL,bool bIsData=false);
	void AddClassVFPTRWatch(CSDSModule* pSDSModule,DWORD TypeIndex,DWORD Address,DWORD Attribute,HANDLE hItem, const char* DataMemberName);
