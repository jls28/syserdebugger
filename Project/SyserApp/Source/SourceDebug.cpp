...
const WCHAR* const basetypename[]=
{
...
const WCHAR *CSourceDebug::GetSymbolTypeName(IN IDiaSymbol* Symbol,IN DWORD NameMaxLen,OUT WCHAR *Name)
{
	IDiaSymbol *SymbolType=NULL;
...
const WCHAR * const datakindname[]=
{
	WSTR("DataIsUnknown"),
	WSTR("DataIsLocal"),
...
const WCHAR* const LocationTypeName[]=
{
	WSTR("LocIsNull"),
	WSTR("LocIsStatic"),
	WSTR("LocIsTLS"),
...
const WCHAR * const CV_access_eName[]=
{
	WSTR(""),
	WSTR("CV_private"),
	WSTR("CV_protected"),
...
const WCHAR *CSourceDebug::GetSymbolName(IN IDiaSymbol* Symbol,IN DWORD NameMaxLen,OUT WCHAR *Name)
{
...
const char *CSourceDebug::GetBaseTypeName1(DWORD BaseType,DWORD length)
{
...
const PREDEFINEBASETYPE gPreDefineBaseType[]=
{
	{1*0x80,1,"char"},
	{2*0x80,2,"short"},
	{4*0x80,4,"int"},
...
DWORD CSourceDebug::MakeSDPointerType(IDiaSymbol* Symbol,DWORD *ReleaseFlags,SDTYPE** pTypeRetrun)
{
	...
	ULONGLONG length;
	static const char NullPointerName[]="";
...
const char* CSourceDebug::GetCallConventionName(DWORD dwType)
{
	int i;
...
*/
const WCHAR* CSourceDebug::GetRegisterNameById(DWORD RegId)
{
	static CV_HREG_eName RegName[]=
	{
...
bool CSourceDebug::DumpHeaderFile(const char* HeaderFileName)
{
	PSDCLASSTYPE pSDClassType;
	PSDTYPE pType;
...
const SDBASETYPENAME BaseTypeNameStructArray[27]=
{
	{btNoType,"NoType"},
	{btVoid,"void"},
	{btChar,"char"},
