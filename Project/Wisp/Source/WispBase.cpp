...
#else // JLS
	GetCurrentDirectory(std::size(m_CurDir), m_CurDir);
#endif
...
///////////////////////////////////////////////////////////////////////////////////////////////////
	...
	while(*szBegin)
	{
		...
		{
			auto fa = GetFileAttributes(szWispDatFN);

			auto err = GetLastError(); // JLS
...
int CWispBase::MsgBox(const WISP_CHAR*pText, const WISP_CHAR*pCaption,UINT uType,CWispBaseWnd*pParentWnd)
{
