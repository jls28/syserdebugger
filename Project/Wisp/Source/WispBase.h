...
//平台相关接口
	...
	//Frame
	virtual bool	CreateFrame(const WISP_CHAR*WndName,int Width,int Height,int Bpp)=0;
...
public:
	...
	int				MsgBox(const WISP_CHAR* pText, const WISP_CHAR* pCaption, UINT uType = 0,CWispBaseWnd* pParentWnd = NULL);
public:
