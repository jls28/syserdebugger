...
bool CWispEdit::Create( IN const WISP_CHAR*Name,IN const CWispRect&Rect,IN CWispBaseWnd*pParentWnd,IN UINT CmdID,	IN UINT Style,IN UINT ShowMode)
{
...
bool CWispEdit::Create(IN const WISP_CHAR* Name,IN INT x,IN INT y,IN INT cx,IN INT cy,IN CWispBaseWnd*pParentWnd,IN UINT CmdID,IN UINT Style,IN UINT ShowMode)
{
