...
int CWispMsgBox::StaticShowMsgBox(const WISP_CHAR* pText, const WISP_CHAR* pCaption, UINT uType,CWispBaseWnd*pParentWnd)
{
	CWispMsgBox MsgBox;
...
int CWispMsgBox::ShowMsgBox(const WISP_CHAR* pText, const WISP_CHAR* pCaption, UINT uType)
{
...
void CWispMsgBox::AddButton(const WISP_CHAR* pText, int nID)
{
	BTNPAIR stPair;
