...
bool CWispToolbar::InsertButton(int Pos,UINT ItemStyle,UINT CmdID,UINT Style,CWispDIB*pWispDIB, const WISP_CHAR*HelpString)
{
	CBTList::IT Iter;
	CWispButton*pWnd;
...
bool CWispToolbar::InsertEdit(int Pos,UINT ItemStyle,int Width,UINT CmdID,UINT Style, const WISP_CHAR*HelpString)
{
	int Height;
	CBTList::IT Iter;
	CWispEdit*pWnd;
