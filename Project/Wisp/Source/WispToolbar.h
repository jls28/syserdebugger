...
public:
	...
	bool	InsertButton(int Pos,UINT ItemStyle,UINT CmdID,UINT Style,CWispDIB*pWispDIB, const WISP_CHAR*HelpString=NULL);
	bool	InsertEdit(int Pos,UINT ItemStyle,int Width,UINT CmdID,UINT Style, const WISP_CHAR*HelpString=NULL);
